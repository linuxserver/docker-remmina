...
* Update the image: `docker pull lscr.io/linuxserver/remmina:latest`
...
* **16.12.22:** - Rebase to Jammy. Drop nx plugin due to lack of packages. Add Kiosk, Secret, x2go plugins.
